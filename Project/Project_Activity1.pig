...
inputFile=LOAD 'hdfs:///user/Bhavana_bigdata/inputs' USING PigStorage('\t') AS (name:chararray,line:chararray)
...
---store the result
STORE result INTO 'hdfs:///user/Bhavana_bigdata/Pigprojectoutput';
